...
fun ReviewComponent(
    ...
    val (leftBarColor: Color, @DrawableRes iconResId: Int?, iconColor: Color) =
        when (type) {
            is ReviewType.BEST -> Triple(bokBookBokColors.main, R.drawable.ic_review_best, bokBookBokColors.main)
            is ReviewType.MYREVIEW -> Triple(bokBookBokColors.second, null, Color.Unspecified)
